...
f = get_csr_features(rgb_img, tracker.c, tracker.currentScaleFactor, tracker.template_size, ...
...
xs = get_scale_subwindow(rgb_img, tracker.c([2,1]), tracker.base_target_sz([2,1]), ...
    tracker.currentScaleFactor * tracker.scaleSizeFactors, tracker.scale_window, tracker.scale_model_sz([2,1]), []);
